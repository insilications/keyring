...
Version  : 10.3.3
Release  : 34
URL      : https://pypi.debian.net/keyring/keyring-10.3.3.tar.gz
Source0  : https://pypi.debian.net/keyring/keyring-10.3.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1496617671
