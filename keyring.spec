...
Source0  : https://files.pythonhosted.org/packages/e2/ca/f7caecaac22e06cf4de0e5144a4f2a47251f8fee598f84d5f3fa1d8709a7/keyring-20.0.0.tar.gz
...
%prep
%setup -q -n keyring-20.0.0
cd %{_builddir}/keyring-20.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575903795
...
cp %{_builddir}/keyring-20.0.0/LICENSE %{buildroot}/usr/share/package-licenses/keyring/a1474494d96f6ddb3a9a0d767a09871ffc388faf
